...
flags.DEFINE_boolean(
    "use_gce_service_account", False, "Only for the gcloud wrapper use."
)
flags.DEFINE_string(
    "credential_file",
...
flags.DEFINE_string("service_account", "", "Only for the gcloud wrapper use.")
flags.DEFINE_string(
...
flags.DEFINE_string(
    "service_account_credential_file", None, "Only for the gcloud wrapper use."
)

...
flags.DEFINE_string("api", "https://www.googleapis.com", "API endpoint to talk to.")
flags.DEFINE_string("api_version", "v2", "API version to use.")
flags.DEFINE_boolean("debug_mode", False, "Show tracebacks on Python exceptions.")
flags.DEFINE_string("trace", None, "A tracing token " "to include in api requests.")
flags.DEFINE_string(
    "httplib2_debuglevel",
    None,
...
flags.DEFINE_string("ca_certificates_file", "", "Location of CA certificates file.")
flags.DEFINE_string(
    "proxy_address",
    "",
...
flags.DEFINE_integer(
    "max_rows_per_request", None, "Specifies the max number of rows to return per read."
)
...
flags.DEFINE_boolean(
    "mtls", False, "If set will use mtls client certificate on connections to BigQuery."
)

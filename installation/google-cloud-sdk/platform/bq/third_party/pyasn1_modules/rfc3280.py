...
OrganizationalUnitNames.subtypeSpec = constraint.ValueSizeConstraint(
...
BuiltInDomainDefinedAttributes.subtypeSpec = constraint.ValueSizeConstraint(
...
ExtensionAttributes.subtypeSpec = constraint.ValueSizeConstraint(
...
TeletexDomainDefinedAttributes.subtypeSpec = constraint.ValueSizeConstraint(
    1, ub_domain_defined_attributes
)
...
TeletexOrganizationalUnitNames.subtypeSpec = constraint.ValueSizeConstraint(
    1, ub_organizational_units
)

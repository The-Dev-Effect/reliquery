...
def build_from_document(
    ...
    if http is None:
        ...
        if use_client_cert == "true":
            client_cert_used = add_mtls_creds(
                http, client_options, adc_cert_path, adc_key_path
            )

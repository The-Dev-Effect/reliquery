...
class FlagValues:
    ...
    def get_help(
        self, prefix: Text = ..., include_special_flags: bool = ...
    ) -> Text: ...
    ...
    def register_flag_by_module(self, module_name: Text, flag: _flag.Flag) -> None: ...
    def register_flag_by_module_id(self, module_id: Text, flag: _flag.Flag) -> None: ...
    def register_key_flag_for_module(
        self, module_name: Text, flag: _flag.Flag
    ) -> None: ...
    def get_key_flags_for_module(self, module: Any) -> List[_flag.Flag]: ...
    def find_module_defining_flag(self, flagname: Text, default: Any = ...) -> Any: ...
    def find_module_id_defining_flag(
        self, flagname: Text, default: Any = ...
    ) -> Any: ...
    ...
    def read_flags_from_files(
        self, argv: List[Text], force_gnu: bool = ...
    ) -> List[Text]: ...

...
class MacOsTest(unittest.TestCase):
    ...
    @mock.patch.multiple(
        macos, iokit=mock.DEFAULT, cf=mock.DEFAULT, GetDeviceIntProperty=mock.DEFAULT
    )
    def testInitHidDevice(
        self, thread, iokit, cf, GetDeviceIntProperty
    ...
    def testCallReadSuccess(
        ...
        self.assertEquals(
            read_result,
            list(range(64)),
            "Read data should match " "data passed into the callback",
        )

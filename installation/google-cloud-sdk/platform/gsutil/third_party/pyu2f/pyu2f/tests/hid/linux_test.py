...
KEYBOARD_RD = "BQEJAqEBCQGhAAUJGQEpBRUAJQGVBXUBgQKVAXUDgQEFAQkwCTEJOBWBJX91CJUDgQbAwA=="
...
class LinuxTest(unittest.TestCase):
    ...
    def testCallEnumerate(self):
        AddDevice(
            self.fs, "hidraw1", "Logitech USB Keyboard", 0x046D, 0xC31C, KEYBOARD_RD
        )
    ...
    def testCallOpen(self):
        ...
        with mock.patch.object(py_builtins, "open", fake_open):
            ...
            with mock.patch.object(linux, "os", fake_dev_os):
                ...
                # report ID
                self.assertEquals(
                    list(fake_dev_os.data_written), [0] + list(range(0, 64))
                )

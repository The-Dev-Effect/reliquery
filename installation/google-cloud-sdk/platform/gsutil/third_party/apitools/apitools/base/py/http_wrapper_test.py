...
class HttpWrapperTest(unittest.TestCase):
    ...
    @unittest.skipIf(
        not _TOKEN_REFRESH_STATUS_AVAILABLE,
    ...
    def testDefaultExceptionHandler(self):
        ...
        for exception_arg in (
            ...
            exceptions.BadStatusCodeError({"status": 503}, mock_http_content, "url"),
            exceptions.RetryAfterError({"status": 429}, mock_http_content, "url", 0),
        ):

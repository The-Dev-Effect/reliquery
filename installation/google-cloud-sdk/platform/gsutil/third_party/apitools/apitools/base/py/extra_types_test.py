...
class ExtraTypesTest(unittest.TestCase):
    ...
    def testArrayEncoding(self):
        array = [3, "four", False]
        json_array = extra_types.JsonArray(
            entries=[
    ...
    def testJsonObjectPropertyTranslation(self):
        ...
        obj = extra_types.JsonObject(
            properties=[extra_types.JsonObject.Property(key="attr_name", value=value)]
        )
        json_value = '"abc"'
    ...
    def testJsonValueAsFieldTranslation(self):
        ...
        msg = HasJsonValueMsg(
            some_value=encoding.PyValueToMessage(extra_types.JsonValue, [1, 2, 3])
        )
    ...
    def testDateField(self):
        ...
        msg = DateMsg(
            start_date=datetime.date(1752, 9, 9),
            all_dates=[
    ...
    def testInt64(self):
        ...
        # Repeated test case
        msg = DogeMsg(
            such_string="wow", wow=-1234, very_unsigned=800, much_repeated=[123, 456]
        )

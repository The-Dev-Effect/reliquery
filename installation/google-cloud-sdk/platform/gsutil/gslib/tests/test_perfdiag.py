...
class TestPerfDiag(testcase.GsUtilIntegrationTestCase):
    ...
    def setUpClass(cls):
        ...
        cls._custom_endpoint_flags = [
            "-o",
            "Credentials:gs_host=" + gs_ip,
            "-o",
            "Credentials:gs_host_header=" + gs_host,
            "-o",
    ...
    def _should_run_with_custom_endpoints(self):
        ...
        return (
            self.test_api == "XML"
            and not RUN_S3_TESTS
            and python_version_less_than_2_7_9
            and not (
    ...
    def _run_each_parallel_throughput_test(
        self, test_name, num_processes, num_threads, compression_ratio=None
    ):
    ...
    def test_input_output(self):
        ...
        bucket_uri = self.CreateBucket()
        self.RunGsUtil(
            ["perfdiag", "-o", outpath, "-n", "1", "-t", "lat", suri(bucket_uri)]
        )
    ...
    def test_listing(self):
        ...
        stdout = self.RunGsUtil(
            ["perfdiag", "-n", "1", "-t", "list", suri(bucket_uri)], return_stdout=True
        )
...
class TestPerfDiagUnitTests(testcase.GsUtilUnitTestCase):
    ...
    def test_listing_does_not_list_preexisting_objects(self):
        ...
        mock_log_handler = self.RunCommand(
            "perfdiag",
            ["-n", str(test_objects), "-t", "list", suri(bucket_uri)],

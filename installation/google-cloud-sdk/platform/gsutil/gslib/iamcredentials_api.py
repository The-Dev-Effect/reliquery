...
from gslib.third_party.iamcredentials_apitools import (
    iamcredentials_v1_client as apitools_client,
)
from gslib.third_party.iamcredentials_apitools import (
    iamcredentials_v1_messages as apitools_messages,
)
...
class IamcredentailsApi(object):
    ...
    def __init__(self, logger=None, credentials=None, debug=0):
        ...
        self.host_base = config.get(
            "Credentials", "gs_iamcredentails_host", "iamcredentials.googleapis.com"
        )
    ...
    def GenerateAccessToken(self, service_account_id, scopes):
        ...
        request = apitools_messages.IamcredentialsProjectsServiceAccountsGenerateAccessTokenRequest(
        ...
        if isinstance(e, apitools_exceptions.HttpError):
            ...
            if e.status_code == 400:
                ...
                if "The account for the specified project has been disabled" in str(e):
                    ...
                    return AccessDeniedException(
                        message or e.message or service_account_id, status=e.status_code
                    )
                ...
                return ServiceException(
                    "The key %s already exists." % service_account_id,
                    status=e.status_code,
                )

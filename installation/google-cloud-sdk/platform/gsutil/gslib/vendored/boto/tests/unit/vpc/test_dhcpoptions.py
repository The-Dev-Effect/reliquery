...
class TestDescribeDhcpOptions(AWSMockServiceTestCase):
    ...
    def test_get_all_dhcp_options(self):
        ...
        api_response = self.service_connection.get_all_dhcp_options(
            ["dopt-7a8b9c2d"], [("key", "domain-name")]
        )
        ...
        self.assertEquals(
            api_response[0].options["domain-name-servers"], ["10.2.5.1", "10.2.5.2"]
        )
...
class TestCreateDhcpOptions(AWSMockServiceTestCase):
    ...
    def test_create_dhcp_options(self):
        ...
        api_response = self.service_connection.create_dhcp_options(
            ...
            domain_name_servers=["10.2.5.1", "10.2.5.2"],
        ...
        self.assertEquals(
            api_response.options["domain-name-servers"], ["10.2.5.1", "10.2.5.2"]
        )
        self.assertEquals(
            api_response.options["ntp-servers"], ["10.12.12.1", "10.12.12.2"]
        )
...
class TestDeleteDhcpOptions(AWSMockServiceTestCase):
    ...
    def test_delete_dhcp_options(self):
        ...
        self.assert_request_parameters(
            {"Action": "DeleteDhcpOptions", "DhcpOptionsId": "dopt-7a8b9c2d"},
            ignore_params_values=[
                "AWSAccessKeyId",
                "SignatureMethod",
                "SignatureVersion",

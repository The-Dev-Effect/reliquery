...
BASIC_EC2_TEMPLATE = {
    ...
    "Parameters": {
        "Parameter1": {"Description": "Test Parameter 1", "Type": "String"},
        "Parameter2": {"Description": "Test Parameter 2", "Type": "String"},
    },
    ...
    "Resources": {
        "Ec2Instance": {
            ...
            "Properties": {
                ...
                "UserData": {
                    "Fn::Base64": {
                        "Fn::Join": ["", [{"Ref": "Parameter1"}, {"Ref": "Parameter2"}]]
                    }
                },
            },
        }
...
class TestCloudformationConnection(unittest.TestCase):
    ...
    def test_large_template_stack_size(self):
        ...
        self.assertEquals(
            [("Parameter1", "initial_value"), ("Parameter2", "initial_value")], params
        )
        ...
        body = self.connection.update_stack(
            self.stack_name,
            template_body=json.dumps(BASIC_EC2_TEMPLATE),
            parameters=[("Parameter1", "", True), ("Parameter2", "updated_value")],
        )
        ...
        self.assertEquals(
            [("Parameter1", "initial_value"), ("Parameter2", "updated_value")], params
        )

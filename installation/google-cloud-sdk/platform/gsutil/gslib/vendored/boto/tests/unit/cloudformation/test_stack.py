...
class TestStackParse(unittest.TestCase):
    ...
    def test_event_creation_time_with_millis(self):
        ...
        self.assertEqual(
            creation_time, datetime.datetime(2013, 1, 10, 5, 4, 56, 102342)
        )
    ...
    def test_resource_time_with_millis(self):
        ...
        self.assertEqual(
            timestamp_2, datetime.datetime(2010, 7, 27, 22, 28, 28, 123456)
        )
    ...
    def test_list_stacks_time_with_millis(self):
        ...
        self.assertEqual(
            timestamp_3, datetime.datetime(2011, 3, 10, 16, 20, 51, 575757)
        )
    ...
    def test_list_stacks_time_with_millis_again(self):
        ...
        self.assertEqual(
            timestamp_2, datetime.datetime(2011, 6, 21, 20, 25, 57, 875643)
        )

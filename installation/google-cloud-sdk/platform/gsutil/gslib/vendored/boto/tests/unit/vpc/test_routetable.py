...
class TestDescribeRouteTables(AWSMockServiceTestCase):
    ...
    def test_get_all_route_tables(self):
        ...
        self.assertEquals(
            api_response[0].routes[0].destination_cidr_block, "10.0.0.0/22"
        )
        ...
        self.assertEquals(
            api_response[0].associations[0].route_table_id, "rtb-13ad487a"
        )
        ...
        self.assertEquals(
            api_response[1].routes[0].destination_cidr_block, "10.0.0.0/22"
        )
        ...
        self.assertEquals(
            api_response[1].routes[2].destination_cidr_block, "10.0.0.0/21"
        )
        ...
        self.assertEquals(
            api_response[1].routes[3].destination_cidr_block, "11.0.0.0/22"
        )
        self.assertEquals(
            api_response[1].routes[3].vpc_peering_connection_id, "pcx-efc52b86"
        )
        ...
        self.assertEquals(
            api_response[1].associations[0].route_table_id, "rtb-f9ad4890"
        )
...
class TestDisassociateRouteTable(AWSMockServiceTestCase):
    ...
    def test_disassociate_route_table(self):
        self.set_http_response(status_code=200)
        api_response = self.service_connection.disassociate_route_table(
            "rtbassoc-fdad4894"
        )
        self.assert_request_parameters(
            {"Action": "DisassociateRouteTable", "AssociationId": "rtbassoc-fdad4894"},
            ignore_params_values=[
                "AWSAccessKeyId",
                "SignatureMethod",
                "SignatureVersion",
...
class TestCreateRouteTable(AWSMockServiceTestCase):
    ...
    def test_create_route_table(self):
        ...
        self.assert_request_parameters(
            {"Action": "CreateRouteTable", "VpcId": "vpc-11ad4878"},
            ignore_params_values=[
                "AWSAccessKeyId",
                "SignatureMethod",
                "SignatureVersion",
...
class TestDeleteRouteTable(AWSMockServiceTestCase):
    ...
    def test_delete_route_table(self):
        ...
        self.assert_request_parameters(
            {"Action": "DeleteRouteTable", "RouteTableId": "rtb-e4ad488d"},
            ignore_params_values=[
                "AWSAccessKeyId",
                "SignatureMethod",
                "SignatureVersion",
...
class TestDeleteRoute(AWSMockServiceTestCase):
    ...
    def test_delete_route(self):
        self.set_http_response(status_code=200)
        api_response = self.service_connection.delete_route(
            "rtb-e4ad488d", "172.16.1.0/24"
        )
        self.assert_request_parameters(
            {
                "Action": "DeleteRoute",

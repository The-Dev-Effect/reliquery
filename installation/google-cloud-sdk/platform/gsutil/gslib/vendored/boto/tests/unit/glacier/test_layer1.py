...
class GlacierLayer1ConnectionBase(AWSMockServiceTestCase):
    ...
    def setUp(self):
        ...
        self.vault_arn = (
            "arn:aws:glacier:us-east-1:012345678901:vaults/" + self.vault_name
        )
        self.vault_info = {
            u"CreationDate": u"2012-03-16T22:22:47.214Z",
...
class GlacierJobOperations(GlacierLayer1ConnectionBase):
    ...
    def test_initiate_archive_job(self):
        ...
        api_response = self.service_connection.initiate_job(
            self.vault_name, self.job_content
        )
        self.assertDictEqual(content, api_response)
    ...
    def test_get_archive_output(self):
        ...
        response = self.service_connection.get_job_output(
            self.vault_name, "example-job-id"
        )
...
class TestGlacierUploadPart(GlacierLayer1ConnectionBase):
    def test_upload_part_content_range_header(self):
        ...
        self.assertEqual(self.actual_request.headers["Content-Range"], "bytes 1-2/*")
...
class GlacierUploadArchiveResets(GlacierLayer1ConnectionBase):
    def test_upload_archive(self):
        ...
        self.service_connection.upload_archive(
            "vault_name", fake_data, "linear_hash", "tree_hash"
        )

...
class InternalFailure(SimpleException):
    pass
...
class InvalidClientTokenId(SimpleException):
    pass


class InvalidParameterCombination(SimpleException):
    pass


class InvalidParameterValue(SimpleException):
    pass


class InvalidQueryParameter(SimpleException):
    pass
...
class MissingAction(SimpleException):
    pass


class MissingAuthenticationToken(SimpleException):
    pass


class MissingParameter(SimpleException):
    pass


class OptInRequired(SimpleException):
    pass
...
class ServiceUnavailable(SimpleException):
    pass
...
class TooManyApplications(SimpleException):
    pass
...
class S3LocationNotInServiceRegion(SimpleException):
    pass


class TooManyApplicationVersions(SimpleException):
    pass


class TooManyConfigurationTemplates(SimpleException):
    pass


class TooManyEnvironments(SimpleException):
    pass

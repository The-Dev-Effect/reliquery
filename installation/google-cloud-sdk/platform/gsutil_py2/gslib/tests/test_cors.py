    ...
    def test_set_wildcard_non_null_cors(self):
        ...
        self.assertTrue(
            common_prefix.startswith(
                "gs://%sgsutil-test-test-set-wildcard-non" % random_prefix
            )
        )
        ...
        def _Check1():
            ...
            for line in outlines:
                ...
                if (
                    "You are using a deprecated alias" in line
                    or "gsutil help cors" in line
                    or 'Please use "cors" with the appropriate sub-command' in line
                ):
                    continue
                actual.add(line)

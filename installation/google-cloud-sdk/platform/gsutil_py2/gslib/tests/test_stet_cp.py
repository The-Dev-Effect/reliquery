...
@unittest.skip("STET is disabled.")
class TestStetCp(testcase.GsUtilIntegrationTestCase):
    ...
    def test_encrypts_upload_if_stet_is_enabled(self):
        ...
        stderr = self.RunGsUtil(
            [
                "-o",
                "GSUtil:stet_binary_path={}".format(self.stet_binary_path),
                "-o",
                "GSUtil:stet_config_path={}".format(self.stet_config_path),
                "cp",
                "--stet",
                test_file,
                suri(object_uri),
        ...
        self.assertIn(
            "config file: --config-file={}".format(self.stet_config_path), stdout
        )

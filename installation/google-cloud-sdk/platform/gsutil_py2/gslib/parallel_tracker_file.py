...
def WriteComponentToParallelUploadTrackerFile(
    tracker_file_name, tracker_file_lock, component, logger, encryption_key_sha256=None
):
...
def WriteParallelUploadTrackerFile(
    tracker_file_name, prefix, components, encryption_key_sha256=None
):

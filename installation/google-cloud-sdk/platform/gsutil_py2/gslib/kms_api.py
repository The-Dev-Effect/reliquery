...
class KmsApi(object):
    ...
    def __init__(self, logger=None, credentials=None, debug=0):
        ...
        self.host_base = config.get(
            "Credentials", "gs_kms_host", "cloudkms.googleapis.com"
        )
    ...
    def CreateCryptoKey(self, keyring_fqn, key_name):
        ...
        cryptokey_msg = apitools_messages.CryptoKey(
            purpose=(apitools_messages.CryptoKey.PurposeValueValuesEnum.ENCRYPT_DECRYPT)
        )
        cryptokey_create_request = (
            apitools_messages.CloudkmsProjectsLocationsKeyRingsCryptoKeysCreateRequest(
    ...
    def _TranslateExceptionAndRaise(self, e, key_name=None):
        ...
        translated_exception = self._TranslateApitoolsException(e, key_name=key_name)

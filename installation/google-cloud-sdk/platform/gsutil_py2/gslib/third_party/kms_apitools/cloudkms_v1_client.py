...
class CloudkmsV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_keyRings_cryptoKeys_cryptoKeyVersions = (
            self.ProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsService(self)
        )
        self.projects_locations_keyRings_cryptoKeys = (
            self.ProjectsLocationsKeyRingsCryptoKeysService(self)
        )

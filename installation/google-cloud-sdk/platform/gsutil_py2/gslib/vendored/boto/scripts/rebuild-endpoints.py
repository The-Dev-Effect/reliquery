...
def load_endpoints(endpoints_file):
    ...
    try:
        ...
        print(
            "Could not import botocore, make sure it's installed or "
...
def main():
    ...
    parser.add_argument(
        "--endpoints-file",
        help=(
            "Path to endpoints.json.  If this argument is not given, "
    ...
    exclusive.add_argument(
        ...
        action="store_true",
        help=(
            "Overwrite the endpoints file built into boto2. This is not "
    ...
    exclusive.add_argument(
        ...
        action="store_true",
        help=(
            "Generate the endpoints in the legacy format, suitable for use "
            "as custom endpoints."
        ),
    )
    ...
    json_data = json.dumps(endpoints_data, indent=2, separators=(",", ": "))

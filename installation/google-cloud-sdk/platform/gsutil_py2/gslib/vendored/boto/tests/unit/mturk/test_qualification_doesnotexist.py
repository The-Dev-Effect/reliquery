...
class TestMTurkPostingWithQualificationsDoesnotexist(AWSMockServiceTestCase):
    ...
    def test_qualification_doesnotexist(self):
        ...
        test_requirement = Requirement(
            qualification_type_id=QUAL_NO_ONE_ELSE_HAS_ID, comparator="DoesNotExist"
        )
        ...
        self.assert_request_parameters(
            {
                "QualificationRequirement.1.Comparator": "DoesNotExist",
                "QualificationRequirement.1.QualificationTypeId": "333333333333333333333333333333",
            },

...
class TestDomain(unittest.TestCase):
    ...
    def test_domain_list_activities(self):
        self.domain._swf.list_activity_types.return_value = {
            "typeInfos": [
                {
                    "activityType": {"name": "DeleteLocalFile", "version": "1.0"},
                ...
                {
                    "activityType": {"name": "GrayscaleTransform", "version": "1.0"},
    ...
    def test_domain_list_workflows(self):
        ...
        for workflow_type in workflow_types:
            ...
            self.assertEquals(
                self.domain.aws_access_key_id, workflow_type.aws_access_key_id
            )
            self.assertEquals(
                self.domain.aws_secret_access_key, workflow_type.aws_secret_access_key
            )
    ...
    def test_domain_list_executions(self):
            ...
            "executionInfos": [
                {
                    ...
                    "execution": {
                        "runId": "12OeDTyoD27TDaafViz/QIlCHrYzspZmDgj0coIfjm868=",
                ...
                },
                {
                    "cancelRequested": False,
                    "execution": {
                        "runId": "12GwBkx4hH6t2yaIh8LYxy5HyCM6HcyhDKePJCg0/ciJk=",
                ...
                },
                {
                    "cancelRequested": False,
                    "execution": {
                        "runId": "12oRG3vEWrQ7oYBV+Bqi33Fht+ZRCYTt+tOdn5kLVcwKI=",
                ...
                },
                {
                    "cancelRequested": False,
                    "execution": {
                        "runId": "12qrdcpYmad2cjnqJcM4Njm3qrCGvmRFR1wwQEt+a2ako=",
        ...
        for wf_execution in executions:
            ...
            self.assertEquals(
                self.domain.aws_access_key_id, wf_execution.aws_access_key_id
            )
            self.assertEquals(
                self.domain.aws_secret_access_key, wf_execution.aws_secret_access_key
            )

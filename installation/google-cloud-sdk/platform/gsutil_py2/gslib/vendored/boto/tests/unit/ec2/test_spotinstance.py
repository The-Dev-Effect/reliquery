...
class TestCancelSpotInstanceRequests(AWSMockServiceTestCase):
    ...
    def test_cancel_spot_instance_requests(self):
        ...
        response = self.service_connection.cancel_spot_instance_requests(
            ["sir-1a2b3c4d", "sir-9f8e7d6c"]
        )
...
class TestGetSpotPriceHistory(AWSMockServiceTestCase):
    ...
    def test_get_spot_price_history(self):
        ...
        self.assert_request_parameters(
            {"Action": "DescribeSpotPriceHistory", "InstanceType": "c3.large"},
            ignore_params_values=[
                "AWSAccessKeyId",
                "SignatureMethod",
                "SignatureVersion",
        ...
        self.assert_request_parameters(
            {"Action": "DescribeSpotPriceHistory", "NextToken": "foobar"},
            ignore_params_values=[
                "AWSAccessKeyId",
                "SignatureMethod",
                "SignatureVersion",

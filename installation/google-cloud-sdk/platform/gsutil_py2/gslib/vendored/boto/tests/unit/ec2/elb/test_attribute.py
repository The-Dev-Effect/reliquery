...
ATTRIBUTE_TESTS = [
    (ATTRIBUTE_GET_TRUE_CZL_RESPONSE, [("cross_zone_load_balancing.enabled", True)]),
    (ATTRIBUTE_GET_FALSE_CZL_RESPONSE, [("cross_zone_load_balancing.enabled", False)]),
    (ATTRIBUTE_GET_CS_RESPONSE, [("connecting_settings.idle_timeout", 30)]),
]

...
from boto.cloudsearch2.document import (
    CommitMismatchError,
    EncodingError,
    ContentTooLongError,
...
class CloudSearchDocumentConnectionTest(AWSMockServiceTestCase):
    ...
    def test_proxy(self):
        ...
        self.assertEqual(
            service.proxy, {"http": "http://john.doe:p4ssw0rd@127.0.0.1:8180"}
        )
...
class CloudSearchDocumentSingleTest(CloudSearchDocumentTest):
    ...
    def test_cloudsearch_add_basics(self):
        ...
        document.add(
            "1234",
            {"id": "1234", "title": "Title 1", "category": ["cat_a", "cat_b", "cat_c"]},
        )
        document.commit()
...
class CloudSearchDocumentMultipleAddTest(CloudSearchDocumentTest):
    ...
    def test_cloudsearch_add_basics(self):
        ...
        for arg in args:
            ...
            self.assertEqual(
                arg["fields"]["title"], self.objs[arg["id"]]["fields"]["title"]
            )
            self.assertEqual(
...
class CloudSearchBadSDFTesting(CloudSearchDocumentTest):
    ...
    def test_cloudsearch_erroneous_sdf(self):
        ...
        document.add(
            "1234",
            {"id": "1234", "title": None, "category": ["cat_a", "cat_b", "cat_c"]},
        )

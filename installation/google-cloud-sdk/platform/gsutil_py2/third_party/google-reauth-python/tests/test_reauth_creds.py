...
class ReauthCredsTest(unittest.TestCase):
    ...
    def _run_refresh_test(
        self, http_mock, access_token, refresh_token, token_expiry, invalid
    ):
        ...
        self._check_credentials(
            creds, store, access_token, refresh_token, token_expiry, invalid
        )
    ...
    def _check_credentials(
        self, creds, store, access_token, refresh_token, token_expiry, invalid
    ):

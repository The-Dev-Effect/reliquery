        ...
        return (
            tuple(
                (
                    ...
                    (Ellipsis if param.annotation is param.empty else param.annotation),
                    str(param.kind).lower(),
                )
                for param in sig.parameters.values()
            ),
            (Ellipsis if sig.return_annotation is sig.empty else sig.return_annotation),
        )
...
"""
    ...
    def test_signature_on_lambdas(self):
        self.assertEqual(
            ...
            ((("a", 10, Ellipsis, "positional_or_keyword"),), Ellipsis),
        )

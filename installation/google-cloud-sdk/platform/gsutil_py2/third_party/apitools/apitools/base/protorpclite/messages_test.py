...
class ValidationErrorTest(test_util.TestCase):
    def testStr_NoFieldName(self):
        ...
        self.assertEquals(
            "Validation error", str(messages.ValidationError("Validation error"))
        )
...
class EnumTest(test_util.TestCase):
    ...
    def testDefEnum(self):
        ...
        WeekDay = messages.Enum.def_enum(
            {
                "Monday": 1,
                "Tuesday": 2,
                "Wednesday": 3,
    ...
    def testNegativeInt(self):
        ...
        self.assertRaises(
            messages.EnumDefinitionError, messages.Enum.def_enum, {"Bad": -1}, "BadEnum"
        )
    ...
    def testDefinitionName_Nested(self):
        ...
        module_name = test_util.get_module_name(EnumTest)
        self.assertEquals(
            "%s.MyMessage.NestedEnum" % module_name,
            MyMessage.NestedEnum.definition_name(),
        )
        self.assertEquals(
            "%s.MyMessage" % module_name, MyMessage.NestedEnum.outer_definition_name()
        )
...
class FieldListTest(test_util.TestCase):
    ...
    def testDoNotAutoConvertString(self):
        ...
        self.assertRaises(
            messages.ValidationError, messages.FieldList, string_field, "abc"
        )
    ...
    def testConstructorCopies(self):
        ...
        self.assertFalse(
            field_list is messages.FieldList(self.integer_field, field_list)
        )
    ...
    def testConstructor_InvalidValues(self):
        self.assertRaisesWithRegexpMatch(
            ...
            re.escape(
                "Expected type %r "
                "for IntegerField, found 1 (type %r)" % (six.integer_types, str)
            ),
            messages.FieldList,
            self.integer_field,
            ["1", "2", "3"],
    ...
    def testSetSlice_InvalidValues(self):
        ...
        msg_re = re.escape(
            "Expected type %r "
            "for IntegerField, found 10 (type %r)" % (six.integer_types, str)
        )
...
class FieldTest(test_util.TestCase):
    ...
    def testNumberAttribute(self):
        ...
        def action(field_class):
            ...
            self.assertRaises(
                messages.InvalidNumberError, field_class, messages.MAX_FIELD_NUMBER + 1
            )

            # Check reserved.
            self.assertRaises(
                messages.InvalidNumberError,
                field_class,
    ...
    def testDefaultFields_InvalidSingle(self):
        ...
        def action(field_class):
            self.assertRaises(
                messages.InvalidDefaultError, field_class, 1, default=object()
            )
    ...
    def testDefaultFields_EnumIntDelayedResolution(self):
        ...
        field = messages.EnumField(
            "apitools.base.protorpclite.descriptor.FieldDescriptor.Label", 1, default=2
        )
    ...
    def testDefaultFields_EnumOkIfTypeKnown(self):
        ...
        field = messages.EnumField(
            descriptor.FieldDescriptor.Label, 1, default="REPEATED"
        )
    ...
    def testDefaultFields_EnumForceCheckIfTypeKnown(self):
        ...
        self.assertRaisesWithRegexpMatch(
            TypeError,
            "No such value for NOT_A_LABEL in " "Enum Label",
            messages.EnumField,
    ...
    def testDefaultFields_EnumInvalidDelayedResolution(self):
        ...
        self.assertRaisesWithRegexpMatch(
            TypeError, "No such value for 200 in Enum Label", getattr, field, "default"
        )
    ...
    def testValidate_Valid(self):
        ...
        def action(field_class):
            ...
            self.assertRaises(
                messages.ValidationError, field.validate, values[field_class]
            )
            self.assertRaises(
                messages.ValidationError, field.validate, values[field_class]
            )
    ...
    def testValidate_None(self):
        ...
        def action(field_class):
            ...
            self.assertRaisesWithRegexpMatch(
                messages.ValidationError,
                "Repeated values for %s may " "not be None" % field_class.__name__,
                field.validate,
                [None],
            )
    ...
    def testValidateElement(self):
        ...
        def action(field_class):
            ...
            self.assertRaises(
                ...
                list(values[field_class]),
            )  # testing list
            self.assertRaises(
                messages.ValidationError, field.validate_element, values[field_class]
            )  # testing tuple
    ...
    def testValidateCastingElement(self):
        ...
        self.assertRaises(
            messages.ValidationError, field.validate_element, 12.0
        )  # should fails from float to int
    ...
    def testReadOnly(self):
        ...
        def action(field_class):
            ...
            self.assertRaises(
                AttributeError, setattr, field, "anything_else", "whatever"
            )
    ...
    def testMessageField(self):
        ...
        self.assertRaises(
            messages.FieldDefinitionError, messages.MessageField, messages.Message, 10
        )
    ...
    def testMessageField_ForwardReference(self):
        ...
        try:
            ...
            self.assertEquals(
                ForwardMessage.NestedMessage, MyMessage.field_by_name("nested").type
            )

            self.assertEquals(MyMessage.Inner, MyMessage.field_by_name("inner").type)

            self.assertEquals(
                MyMessage.Sibling, MyMessage.Inner.field_by_name("sibling").type
            )
        finally:
            try:
                del MyMessage
    ...
    def testMessageFieldValueFromMessageWrongType(self):
        ...
        self.assertRaisesWithRegexpMatch(
            ...
            HasMessage.field.value_from_message,
            10,
        )
    ...
    def testMessageFieldValueToMessageWrongType(self):
        ...
        self.assertRaisesWithRegexpMatch(
            ...
            HasMessage.field.value_to_message,
            instance,
        )
    ...
    def testEnumField(self):
        ...
        self.assertRaises(
            messages.FieldDefinitionError, messages.EnumField, messages.Enum, 10
        )
    ...
    def testEnumField_ForwardReference(self):
        ...
        try:
            ...
            self.assertEquals(
                ForwardMessage.NestedEnum, MyMessage.field_by_name("nested").type
            )
    ...
    def testMessageDefinition(self):
        ...
        self.assertEquals(
            MyMessage, MyMessage.field_by_name("my_field").message_definition()
        )
...
class MessageTest(test_util.TestCase):
    ...
    def testEqualityWithUnknowns(self):
        ...
        message1.set_unrecognized_field(
            "unknown2", ["asdf", 3], messages.Variant.STRING
        )
    ...
    def testValidation(self):
        ...
        message_field.validate(message)
        self.assertRaises(
            messages.ValidationError, setattr, message, "val", [SubMessage()]
        )
    ...
    def testUnknownValues(self):
        ...
        self.assertEquals(
            (None, None), message.get_unrecognized_field_info("doesntexist")
        )
        self.assertEquals(
            (None, None), message.get_unrecognized_field_info("doesntexist", None, None)
        )
        self.assertEquals(
            ("defaultvalue", "defaultwire"),
        ...
        self.assertEquals(
            (3, None),
            message.get_unrecognized_field_info("doesntexist", value_default=3),
        )
        ...
        self.assertEquals(
            (9.5, messages.Variant.DOUBLE),
            message.get_unrecognized_field_info("exists"),
        )
        self.assertEquals(
            (9.5, messages.Variant.DOUBLE),
            message.get_unrecognized_field_info("exists", "type", 1234),
        )
        self.assertEquals(
            (1234, None), message.get_unrecognized_field_info("doesntexist", 1234)
        )
        ...
        self.assertEquals(
            ("value", messages.Variant.STRING),
            message.get_unrecognized_field_info("another"),
        )

        message.set_unrecognized_field(
            "typetest1", ["list", 0, ("test",)], messages.Variant.STRING
        )
        self.assertEquals(
            (["list", 0, ("test",)], messages.Variant.STRING),
    ...
    def testPickle(self):
        ...
        message = MyMessage(
            field1=1, field2=MyEnum.val2, field3=AnotherMessage(string=["a", "b", "c"])
        )
        message.set_unrecognized_field("exists", "value", messages.Variant.STRING)
        message.set_unrecognized_field(
            "repeated", ["list", 0, ("test",)], messages.Variant.STRING
        )
...
class FindDefinitionTest(test_util.TestCase):
    ...
    def testGlobalFind(self):
        ...
        self.assertEquals(
            A, messages.find_definition("a.b.c.A", importer=self.Importer)
        )
        B = self.DefineMessage("a.b.c", "B", {"C": {}})
        self.assertEquals(
            B.C, messages.find_definition("a.b.c.B.C", importer=self.Importer)
        )
    ...
    def testRelativeToModule(self):
        ...
        self.assertEquals(
            C, messages.find_definition("b.c.C", a, importer=self.Importer)
        )
        self.assertEquals(
            D, messages.find_definition("b.d.D", a, importer=self.Importer)
        )
    ...
    def testRelativeToMessages(self):
        ...
        self.assertEquals(
            B, messages.find_definition("b.A.B", C, importer=self.Importer)
        )
        self.assertEquals(
            C, messages.find_definition("b.A.B.C", C, importer=self.Importer)
        )
        self.assertEquals(
            D, messages.find_definition("b.A.B.D", C, importer=self.Importer)
        )
    ...
    def testAbsoluteReference(self):
        ...
        # Always find a.A.
        self.assertEquals(
            aA, messages.find_definition(".a.A", None, importer=self.Importer)
        )
        self.assertEquals(
            aA, messages.find_definition(".a.A", a, importer=self.Importer)
        )
        self.assertEquals(
            aA, messages.find_definition(".a.A", aA, importer=self.Importer)
        )
        self.assertEquals(
            aA, messages.find_definition(".a.A", aaA, importer=self.Importer)
        )
    ...
    def testFindEnum(self):
        ...
        self.assertEquals(
            Color, messages.find_definition("Color", A, importer=self.Importer)
        )
    ...
    def testSearchAttributeFirst(self):
        ...
        self.assertEquals(
            A, messages.find_definition("a.A", None, importer=self.Importer)
        )

...
def main(argv=None):
    if argv is None:
        argv = sys.argv
    parser = argparse.ArgumentParser(description="Apitools Client Code Generator")
    ...
    parser.add_argument(
        ...
        help=(
            "Base package path of protorpc " "(defaults to apitools.base.protorpclite"
        ),
    )
    ...
    parser.add_argument(
        "--root_package",
        default="",
        help=("Python import path for where these modules " "should be imported from."),
    )
    ...
    parser.add_argument(
        ...
        default=[],
        help=(
            "Prefix to strip from type names in the discovery document. "
            "(May be specified multiple times.)"
        ),
    )

    parser.add_argument("--api_key", help=("API key to use for API access."))

    parser.add_argument(
        "--client_json",
        help=(
            "Use the given file downloaded from the dev. console for "
    ...
    parser.add_argument(
        ...
        default=[],
        help=(
            "Scopes to request in the generated client. "
    ...
    parser.add_argument(
        "--generate_cli", dest="generate_cli", action="store_true", help="Ignored."
    )
    parser.add_argument(
        "--nogenerate_cli", dest="generate_cli", action="store_false", help="Ignored."
    )
    ...
    parser.add_argument(
        "--apitools_version",
        default="",
        dest="apitools_version",
        help=(
            "Apitools version used as a requirement in generated clients. "

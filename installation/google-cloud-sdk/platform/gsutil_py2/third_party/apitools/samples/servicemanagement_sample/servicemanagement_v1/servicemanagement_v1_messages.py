...
class Billing(_messages.Message):
    ...
    areaUnderCurveParams = _messages.MessageField(
        "AreaUnderCurveParams", 1, repeated=True
    )
...
class Logging(_messages.Message):
    ...
    consumerDestinations = _messages.MessageField(
        "LoggingDestination", 1, repeated=True
    )
    producerDestinations = _messages.MessageField(
        "LoggingDestination", 2, repeated=True
    )
...
class Monitoring(_messages.Message):
    ...
    consumerDestinations = _messages.MessageField(
        "MonitoringDestination", 1, repeated=True
    )
    producerDestinations = _messages.MessageField(
        "MonitoringDestination", 2, repeated=True
    )
...
class QuotaSettings(_messages.Message):
    ...
    effectiveQuotaGroups = _messages.MessageField(
        "EffectiveQuotaGroup", 2, repeated=True
    )
...
class Service(_messages.Message):
    ...
    monitoredResources = _messages.MessageField(
        "MonitoredResourceDescriptor", 16, repeated=True
    )
...
class ServiceAccessPolicy(_messages.Message):
    ...
    visibilityLabelAccessLists = _messages.MessageField(
        "VisibilityLabelAccessListsValue", 3
    )

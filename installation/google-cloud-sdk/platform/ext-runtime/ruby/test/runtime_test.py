...
class RuntimeTestCase(testutil.TestBase):
    ...
    def test_generate_with_deploy_no_write(self):
        ...
        dockerignore = [f.contents for f in cfg_files if f.filename == ".dockerignore"][
            0
        ]
        self.assertIn(".dockerignore\n", dockerignore)
        self.assertIn("Dockerfile\n", dockerignore)
    ...
    def test_generate_with_custom(self):
        ...
        self.assertEqual(
            dockerfile,
            DOCKERFILE_TEXT.format(
                ruby_version="", entrypoint="bundle exec rackup -p $PORT -E deployment"
            ),
        )
    ...
    def test_generate_with_existing_appinfo(self):
        ...
        appinfo = testutil.AppInfoFake(
            entrypoint="bundle exec ruby index.rb $PORT", runtime="ruby", vm=True
        )
        ...
        self.assertEqual(
            dockerfile,
            DOCKERFILE_TEXT.format(
                ruby_version="", entrypoint="bundle exec ruby index.rb $PORT"
            ),
        )
    ...
    def test_generate_with_ruby_version(self):
        ...
        self.assertEqual(
            dockerfile,
            DOCKERFILE_TEXT.format(
                ruby_version="2.3.1", entrypoint="bundle exec ruby index.rb $PORT"
            ),
        )
